...
export default function Survey({
                                 ...
                                 questionSixPartOneSelected, questionSixPartTwoSelected,
                                 questionSixPartThreeSelected, questionSixPartFourSelected,
  ...
  const questionThreeConstants = [
    {
      icon: "fas fa-umbrella-beach",
      text: <span>Under 30 <br/> Hours <br/> Per Week</span>,
      responseSelector: "Q3Option1",
    },
    {
      icon: "fas fa-sun",
      text: <span>30-40 <br/> Hours <br/> Per Week</span>,
      responseSelector: "Q3Option2",
    },
    {
      icon: "fas fa-lightbulb",
      text: <span>40-50 <br/> Hours <br/> Per Week</span>,
      responseSelector: "Q3Option3",
    },
    {
      icon: "fas fa-moon",
      text: <span>50-60 <br/> Hours <br/> Per Week</span>,
      responseSelector: "Q3Option4",
    },
    {
      icon: "fas fa-star",
      text: <span>60+ <br/> Hours <br/> Per Week</span>,
      responseSelector: "Q3Option5",
    },
  ];

  const questionFourConstants = [
    {
      icon: "fas fa-sun",
      text: <span>Sunshine</span>,
      responseSelector: "Q4Option1",
    },
    {
      icon: "fas fa-umbrella",
      text: <span>No Rain</span>,
      responseSelector: "Q4Option2",
    },
    {
      icon: "fas fa-umbrella-beach",
      text: <span>Nice Beach</span>,
      responseSelector: "Q4Option3",
    },
    {
      icon: "fas fa-thermometer-empty",
      text: <span>Mild Climate</span>,
      responseSelector: "Q4Option4",
    },
    {
      icon: "fas fa-leaf",
      text: <span>Beautiful Nature</span>,
      responseSelector: "Q4Option5",
    },
  ];

  const questionFiveConstants = [
    {
      icon: "fas fa-money-bill-alt",
      text: <span>Work is for paycheck <br/> That's it</span>,
      responseSelector: "Q5Option1",
    },
    {
      icon: "fas fa-user-clock",
      text: <span>Can work <br/> more hours for <br/> more money</span>,
      responseSelector: "Q5Option2",
    },
    {
      icon: "fas fa-people-carry",
      text: <span>Colleague <br/> Quality <br/> Is important</span>,
      responseSelector: "Q5Option3",
    },
    {
      icon: "fas fa-exchange-alt",
      text: <span>Need to<br/> Change jobs <br/> When I want to</span>,
      responseSelector: "Q5Option4",
    },
    {
      icon: "fas fa-gift",
      text: <span>My products <br/> Are like <br/> My children</span>,
      responseSelector: "Q5Option5",
    },
  ];

  const questionSixPartOneConstants = [
    {
      icon: "fas fa-graduation-cap",
  ...
  const questionSixPartTwoConstants = [
    {
    ...
    },
    {
      ...
      text: <span>Fluency in<br/>French</span>,
      responseSelector: "Q6Part2Option7",
    },
    {
      icon: "fas fa-user-friends",
      text: <span>Have <br/> Canadian (or PR) <br/> Relatives</span>,
      responseSelector: "Q6Part2Option8",
    },
  ];

  const questionSevenPartOneConstants = [
    {
      icon: "fas fa-piggy-bank",
      text: <span>Work in<br/>Financial<br/>Services</span>,
      responseSelector: "Q7Part1Option1",
    },
    {
      icon: "fas fa-building",
      text: <span>Work in <br/>Corporate<br/>Operations</span>,
      responseSelector: "Q7Part1Option2",
    },
    {
      icon: "fas fa-medkit",
      text: <span>Work in <br/>Healthcare<br/>Services</span>,
      responseSelector: "Q7Part1Option3",
    },
    {
      icon: "fas fa-desktop",
      text: <span>Data Scientist / <br/> Software Engineer</span>,
      responseSelector: "Q7Part1Option4",
    },
    {
      icon: "fas fa-store",
      text: <span>SME / <br/> Self-Employed <br/> Entrepreneur</span>,
      responseSelector: "Q7Part1Option5",
    },
  ];

  const questionSevenPartTwoConstants = [    {
      ...
      text: "Adelaide",
      responseSelector: "Q7Part2Option1",
    },    {
      ...
      text: "Dublin",
      responseSelector: "Q7Part2Option4"
    },    {
      ...
      text: "London",
      responseSelector: "Q7Part2Option5"
    },    {
      ...
      text: "Los Angeles",
      responseSelector: "Q7Part2Option6"
    },    {
      ...
      text: "Melbourne",
      responseSelector: "Q7Part2Option7"
    },    {
      ...
      text: "Miami",
      responseSelector: "Q7Part2Option8"
    },    {
      ...
      text: "San Francisco",
      responseSelector: "Q7Part2Option11"
    },    {
      ...
      text: "Sydney",
      responseSelector: "Q7Part2Option12"
    },    {
      ...
      text: "Toronto",
      responseSelector: "Q7Part2Option13"
    },    {
      ...
      text: "Vancouver",
      responseSelector: "Q7Part2Option14"
    },
  ];
  ...
  const getOption = ({icon, text, responseSelector}, index, questionSelector, questionSelected, cb, divClassNameOne, divClassNameTwo) => {
    ...
    if (divClassNameOne == "response-icon-small"){
      return <div>
        <div className={getSurveyClassNameTypeThree(questionSevenPartTwoSelected, responseSelector)}
             onClick={() => cb(responseSelector, questionSelector)}>
          <div className={divClassNameOne}>
    ...
    if (divClassNameOne == "response-eight-options") {
      return <div>
        <div key={`question-one-${index}`}
             className={getSurveyClassNameTypeTwo(questionSelected, responseSelector)}
             onClick={() => cb(responseSelector, questionSelector)}>
  ...
  const surveyQuestionTwo = <div className="survey-content">
    ...
    <div className="survey-responses">
      {questionTwoConstants.map((item, index) => getOption(
  ...
  const surveyQuestionThree = <div className="survey-content">
    ...
    <div className="survey-questions">
      What is your ideal weekly work hours?
    </div>
    <div className="survey-responses">
      {questionThreeConstants.map((item, index) => getOption (
  ...
  const surveyQuestionFour = <div className="survey-content">
    ...
    <div className="survey-responses">
      ...
      {
        questionFourConstants.map((item, index) => getOption(
  ...
  const surveyQuestionFive = <div className="survey-content">
    ...
    <div className="survey-responses">
      ...
      {
        questionFiveConstants.map((item, index) => getOption(
  ...
  const surveyQuestionSix = <div className="survey-content">
    ...
    <div className="survey-responses">
      ...
      {
        questionSixPartOneConstants.map((item, index) => getOption(
    ...
    <div className="survey-questions">
      Please select conditions that are applicable to you:
    </div>
    <div className="survey-responses">
      {
        questionSixPartTwoConstants.map((item, index) => getOption(
  ...
  const surveyQuestionSeven = <div className="survey-content">
    ...
    <div className="survey-responses">
      ...
      {
        questionSevenPartOneConstants.map((item, index) => getOption(
    ...
    <div className="survey-responses">
      ...
      {
        questionSevenPartTwoConstants.map((item, index) => getOption(
          item, index, "questionSevenPartTwoAnswer", questionSevenPartTwoSelected, setMultipleAnswer, "response-icon-small", "response-topic"))
      }
